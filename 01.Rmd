...
This big idea provides a huge help for small businesses. It connects and aggregates all their cloud data, such as bank accounts, accounting solutions, to predict the future trends and patterns that could impact cash flow. With such critical data, the application is fully aware of information such as: how much cash is available in the user bank account, how much he owes vendors, how much customers owe him.  
...
Adiditonally, a Model can be built to *recommend* actions and decisions to the user. For instance, when the application detects a potential financial impact, it will proactively alert and suggest a solution to the user.


## An end.

The solution will use these critical attributes to draw valuable insights for the small businesses to become more proactive and better business planners, which could easily be the reason for business survival. Now with such valuable information available at their fingertips, small business owners will have sound confidence in their decision and clear visibility to what is coming ahead. 
