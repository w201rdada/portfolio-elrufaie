...
The success of this can be which can be measured in multiple ways: 
1. Engagement Score: by measuring how often existing users use the tool and if their usage pattern is trending up.
